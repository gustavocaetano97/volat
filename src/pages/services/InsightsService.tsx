...
import { Database, Calendar, LineChart, Search, Lightbulb, Gauge } from 'lucide-react';
import Header from '../../components/Header';
import Footer from '../../components/Footer';
import InsightsAnimation from '../../components/DashboardAnimations/InsightsAnimation';
  ...
  const features = [
    {
      ...
      description: "Previsões baseadas em dados para tomada de decisão informada."
    },
    {
      icon: Search,
      title: "Descoberta de Padrões",
      description: "Identificação de tendências e comportamentos relevantes."
    },
    {
      icon: Lightbulb,
      title: "Recomendações Acionáveis",
      description: "Insights práticos que podem ser implementados imediatamente."
    },
    {
      icon: Gauge,
      title: "Monitoramento em Tempo Real",
      description: "Acompanhamento contínuo de métricas importantes."
    }
  ];
    ...
    <div className="min-h-screen bg-black">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                <span className="font-syncopate text-[#6b2c84] tracking-wider">INSIGHTS DE DADOS</span>
              </motion.div>
              ...
              >
                Transforme dados complexos em insights acionáveis que impulsionam o crescimento do seu negócio e otimizam a tomada de decisão.
              </motion.p>
      ...
      <section className="py-20 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            Pronto para desbloquear o poder dos seus dados?
          </motion.h2>
          ...
          >
            Agende uma análise gratuita e descubra como podemos transformar seus dados em vantagem competitiva.
          </motion.p>
